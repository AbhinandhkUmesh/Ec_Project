  ...
  setTimeout(function () {
    $(document).ready(function () {
      var chart = c3.generate({
        ...
        data: {
          columns: [['data1', 21, 8, 32, 18, 19, 17, 23, 12, 25, 37], ['data2', 7, 11, 5, 7, 9, 16, 15, 23, 14, 55], ['data3', 13, 7, 9, 15, 9, 31, 8, 27, 42, 18]],
          type: 'area-spline',
    ...
    $(document).ready(function () {
      var chart = c3.generate({
        bindto: '#chart-pie',
        data: {
          columns: [['data1', 55], ['data2', 25], ['data3', 20]],
          type: 'pie',
          colors: {
    ...
    $(document).ready(function () {
      var chart = c3.generate({
        ...
        data: {
          columns: [['data1', 11, 8, 15, 7, 11, 13], ['data2', 7, 7, 5, 7, 9, 12]],
          type: 'area-step',
          colors: {
